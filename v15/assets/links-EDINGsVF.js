import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,_ as n,a as r,f as i,h as a,i as o,m as s,p as c,w as l}from"./widev-Dein9EMx.js";import{t as u}from"./wii-BL3abZT3.js";import{t as d}from"./preload-helper-DSbbiTQD.js";var f=`links`,p=()=>`lk`+Date.now(),m=[{id:`ej1`,titulo:`Wilder Taype`,contenido:`https://wtaype.github.io/`,pin:!0,creado:Date.now(),synced:!1},{id:`ej2`,titulo:`NotasWii`,contenido:`https://notaswii.web.app/`,pin:!1,creado:Date.now()-1e3,synced:!1}],h={get:()=>{let e=localStorage.getItem(f);return e===null&&!a.user?[...m]:i(f)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>c(f,e,8760)},g=e=>{try{let t=new URL(e).hostname;return t=t.replace(`www.`,``),t.split(`.`)[0]||`Enlace`}catch{return`Enlace Web`}},_=e=>{let n=e.titulo?e.titulo.charAt(0).toUpperCase():`L`,r=e.contenido||e.url||``;return`
