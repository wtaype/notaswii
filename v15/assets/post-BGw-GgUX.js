...
import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,S as n,h as r,i,w as a}from"./widev-Dein9EMx.js";import{i as o,t as s}from"./wii-BL3abZT3.js";import{t as c}from"./preload-helper-DSbbiTQD.js";import{addView as l,clearPostCache as u,clearRelCache as d,fade as f,getPost as p,getPreview as m,getRelacionados as h,superDate as g,tplShare as _}from"./devblog-iaDpJBSI.js";import{adRight as v}from"./wiad-11_eEey6.js";var y=e=>`<a href="/${e.slug}" class="po_rel_card" ${n(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-clock"></i> ${e.tiempo_lectura} · <i class="fas fa-eye"></i> ${e.vistas||0}</span></div></a>`,b=e=>{let t=e&&m(e);return t?`
      ...
      <div class="po_wrap"><div class="po_layout">
        ...
        <aside class="po_sidebar">
          <div class="po_side_card po_fade" style="--d:.15s">
            ...
            <div class="po_autor_box"><div class="po_autor_av"><img src="/notaswii/v15/smile.avif" alt="${T.autor}"/></div><div class="po_autor_info"><strong>${T.autor}</strong><span>${s} <i class="fas ${o}"></i></span></div></div>
