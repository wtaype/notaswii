import{f as e}from"./widev-Dein9EMx.js";import{E as t,_ as n,w as r,x as i}from"./firebase-CCUuWaKQ.js";import{n as a}from"./firebase-Csc0LBnf.js";var o=async()=>`
  ...
  `,s=async()=>{let o=e(`wiSmile`);if(o)try{let e=await n(i(t(a,`linkwiis`),r(`usuario`,`==`,o.usuario))),s=0,c=0,l=[];e.forEach(e=>{let t=e.data(),n=t.vistas||0,r=t.links?t.links.filter(e=>e.url||e.titulo).length:0;s+=n,c+=r,l.push({slug:e.id,vistas:n,linksCount:r,logo:t.logo})}),l.sort((e,t)=>t.vistas-e.vistas);let u=`
