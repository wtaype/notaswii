import{t as e}from"./vendor-BDh6mtVu.js";import{_ as t,a as n,f as r,h as i,i as a,m as o,p as s,x as c}from"./widev-CInXVJ_O.js";import{t as l}from"./wii-By3LwGGz.js";import{t as u}from"./preload-helper-sXHEIPzj.js";var d=`word_docs`,f=()=>`wd`+Date.now(),p={get:()=>{try{return JSON.parse(localStorage.getItem(d)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(d,JSON.stringify(e))},m=()=>!!r(`wd_sync`),h=()=>s(`wd_sync`,1,168),g=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
