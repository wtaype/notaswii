import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,_ as n,a as r,f as i,h as a,i as o,m as s,p as c,x as l}from"./widev-CInXVJ_O.js";import{t as u}from"./wii-By3LwGGz.js";import{t as d}from"./preload-helper-sXHEIPzj.js";var f=`flash`,p=()=>`fl`+Date.now(),m={get:()=>{try{return JSON.parse(localStorage.getItem(f)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(f,JSON.stringify(e))},h=()=>!!i(`fl_sync`),g=()=>c(`fl_sync`,1,168),_=e=>{let t=Math.floor((Date.now()-e)/1e3);if(t<60)return`Justo ahora`;let n=Math.floor(t/60);if(n<60)return`Hace ${n} min`;let r=Math.floor(n/60);return r<24?`Hace ${r}h`:new Date(e).toLocaleDateString(`es-PE`,{day:`2-digit`,month:`short`})},v=({id:e,pin:t,synced:n,creado:r,contenido:i})=>`
