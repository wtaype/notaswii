import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,_ as n,a as r,f as i,h as a,i as o,m as s,p as c,x as l}from"./widev-CInXVJ_O.js";import{t as u}from"./wii-By3LwGGz.js";import{t as d}from"./preload-helper-sXHEIPzj.js";var f=`links`,p=()=>`lk`+Date.now(),m={get:()=>{try{return JSON.parse(localStorage.getItem(f)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(f,JSON.stringify(e))},h=()=>!!i(`lk_sync`),g=()=>c(`lk_sync`,1,168),_=e=>{try{let t=new URL(e).hostname;return t=t.replace(`www.`,``),t.split(`.`)[0]||`Enlace`}catch{return`Enlace Web`}},v=e=>{let t=e.titulo?e.titulo.charAt(0).toUpperCase():`L`,n=e.contenido||e.url||``;return`
