import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,_ as n,a as r,f as i,h as a,i as o,m as s,p as c,u as l,x as u}from"./widev-BFdt7IHB.js";import{t as d}from"./wii-BA2rwkUR.js";import{t as f}from"./preload-helper-CwLZyQiu.js";var p=`word_docs`,m=()=>`wd`+Date.now(),h=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],g={get:()=>{let e=localStorage.getItem(p);return e===null&&!a.user?[...h]:i(p)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>c(p,e,8760)},_=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
