import{t as e}from"./vendor-BDh6mtVu.js";import{h as t}from"./widev-BFdt7IHB.js";import{c as n,n as r,s as i,t as a}from"./wii-BA2rwkUR.js";function o(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
  ...
  `}e(`body`).append(o()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/v14/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`),e(`body`).append(`
