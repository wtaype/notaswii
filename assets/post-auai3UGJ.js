...
import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,S as n,h as r,i,w as a}from"./widev-CHrYgt0x.js";import{i as o,t as s}from"./wii-Ca7PnfLv.js";import{t as c}from"./preload-helper-D8R59StC.js";import{addView as l,clearPostCache as u,clearRelCache as d,fade as f,getPost as p,getPreview as m,getRelacionados as h,superDate as g,tplShare as _}from"./devblog-CgHgPvAx.js";import{adRight as v}from"./wiad-BJ2SrZGW.js";var y=e=>`<a href="/${e.slug}" class="po_rel_card" ${n(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-clock"></i> ${e.tiempo_lectura} · <i class="fas fa-eye"></i> ${e.vistas||0}</span></div></a>`,b=e=>{let t=e&&m(e);return t?`
