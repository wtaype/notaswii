import{t as e}from"./vendor-BDh6mtVu.js";import{f as t,i as n,p as r}from"./widev-DRhaZoqv.js";import{t as i}from"./wii-Ce1IXd2j.js";import{E as a,h as o,w as s,x as c}from"./firebase-CCUuWaKQ.js";import{n as l}from"./firebase-CCwEX8XK.js";var u=()=>t(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let t=u();!t||t.rol!==`admin`||(e(document).off(`.am`),v(),y(),e(document).on(`click.am`,`#am_btn_refresh`,function(){let t=e(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>t.removeClass(`fa-spin`),500)})}))},_=()=>{e(document).off(`.am`)};function v(){e(`#am_n_total`).text(t(d)||`—`),e(`#am_n_pro`).text(t(f)||`—`),e(`#am_n_org`).text(t(p)||`—`),e(`#am_n_les`).text(t(m)||`45`)}async function y(i=!1){try{let u=a(l,`smiles`);if(i||!t(d)){let t=(await o(u)).data().count;r(d,t),e(`#am_n_total`).text(t)}if(i||!t(f)){let t=(await o(c(u,s(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;r(f,t),e(`#am_n_pro`).text(t)}if(i||!t(p)){let t=(await o(c(u,s(`rol`,`==`,`empresa`)))).data().count;r(p,t),e(`#am_n_org`).text(t)}i&&n(`Estadísticas sincronizadas`,`success`)}catch(e){console.error(`[Admin] Error cargando stats:`,e),i&&n(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};