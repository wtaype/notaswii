import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,_ as n,m as r,n as i,p as a,w as o}from"./widev-BLqPD_AU.js";import{n as s}from"./rutas-BwMw3DB9.js";import{C as c,D as l,u}from"./firebase-BVO2Ew-x.js";import{n as d,t as f}from"./firebase-CSWtr52h.js";var p=()=>a(`wiSmile`)||{},m=()=>{let e=p();if(!e.email)return location.replace(`/`),``;let r=e.nombre||``,i=e.apellidos||``,a=e.usuario||``,o=e.email||``,s=e.rol||`smile`,c=e.plan||`free`,l=e.estado||`activo`,u=(e.tema||`Por defecto`).split(`|`)[0],d=e.uid||``,f=e.avatar||``,m=e.fechaNacimiento||``,h=e.pais||``,g=e.genero||``,_=e.gustos||``,v=e.creado?n(null).get(e.creado,`local`):`Desconocido`,y=`https://ui-avatars.com/api/?name=`+encodeURIComponent(r+` `+i)+`&background=random&color=fff`;return`
  <div class="prf_wrap">

    <div class="prf_hero">
      <div class="prf_av_wrap">
        <img src="${f||y}" alt="${r}" class="prf_av" onerror="this.src='./smile.avif'">
        <div class="prf_av_ring"></div>
      </div>
      <div class="prf_hero_info">
        <h1 class="prf_fullname">${r} ${i}</h1>
  ...
  </div>`},h=()=>{if(!p().email)return s.navigate(`/`);e(document).on(`click.prf`,`#prf_guardar`,async function(){let n=p(),a={nombre:e(`#prf_nombre`).val().trim(),apellidos:e(`#prf_apellidos`).val().trim(),avatar:e(`#prf_avatar`).val().trim(),fechaNacimiento:e(`#prf_nacimiento`).val(),pais:e(`#prf_pais`).val().trim(),genero:e(`#prf_genero`).val()||``,gustos:e(`#prf_gustos`).val().trim()};if(!a.nombre)return t(document.getElementById(`prf_nombre`),`Ingresa tu nombre`,`error`);e(this).prop(`disabled`,!0).html(`<i class="fas fa-spinner fa-spin"></i> Guardando...`);try{await c(l(d,`smiles`,n.usuario),a),r(`wiSmile`,{...n,...a},24),e(`.prf_fullname`).text(`${a.nombre} ${a.apellidos}`),a.avatar?e(`.prf_av`).attr(`src`,a.avatar):e(`.prf_av`).attr(`src`,`https://ui-avatars.com/api/?name=`+encodeURIComponent(a.nombre+` `+a.apellidos)+`&background=random&color=fff`),i(`Perfil actualizado ✅`,`success`)}catch(e){console.error(e),i(`Error al guardar`,`error`)}finally{e(this).prop(`disabled`,!1).html(`<i class="fas fa-save"></i> Guardar cambios`)}}).on(`click.prf`,`#prf_guardar_pass`,async function(){let n=e(`#prf_pass`).val(),r=e(`#prf_pass_conf`).val(),a=e(this);if(!n||n.length<6)return t(document.getElementById(`prf_pass`),`Mínimo 6 caracteres`,`error`);if(n!==r)return t(document.getElementById(`prf_pass_conf`),`Las contraseñas no coinciden`,`error`);if(!f.currentUser)return i(`Sesión expirada. Por favor recarga`,`error`);a.prop(`disabled`,!0).html(`<i class="fas fa-spinner fa-spin"></i> Actualizando...`);try{await u(f.currentUser,n),e(`#prf_pass`).val(``),e(`#prf_pass_conf`).val(``),i(`Contraseña actualizada correctamente ✅`,`success`)}catch(e){console.error(e),e.code===`auth/requires-recent-login`?i(`Por seguridad, cierra sesión y vuelve a ingresar para cambiar la contraseña.`,`error`):i(`Error al actualizar contraseña`,`error`)}finally{a.prop(`disabled`,!1).html(`<i class="fas fa-key"></i> Actualizar contraseña`)}}).on(`click.prf`,`#prf_copy_uid`,function(){o(p().uid||``,this,`¡UID copiado!`)})},g=()=>e(document).off(`.prf`);export{g as cleanup,h as init,m as render};