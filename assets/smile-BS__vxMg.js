import{t as e}from"./vendor-BDh6mtVu.js";import{t}from"./wii-LYmyu9Jv.js";import{a as n,d as r,f as i}from"./widev-CJ_xp4HE.js";import{i as a}from"./firebase-CCUuWaKQ.js";import{t as o}from"./firebase-wt8kx56z.js";var s=()=>new Promise(e=>{if(o.currentUser)return e(o.currentUser);let t=a(o,n=>{t(),e(n)})}),c=e=>{try{return JSON.parse(localStorage.getItem(e))||[]}catch{return[]}},l=[`Confía plenamente, cada paso está guiado.`,`Tu progreso es el testimonio más hermoso.`,`Cada nuevo amanecer es una página en blanco.`,`Transforma obstáculos en oportunidades.`,`Sigue brillando, tus ideas dejarán huella.`],u=()=>`
  <div class="smw_dash">
