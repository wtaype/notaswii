import{t as e}from"./vendor-BDh6mtVu.js";import{a as t}from"./widev-CHrYgt0x.js";import{t as n}from"./preload-helper-D8R59StC.js";import{add as r,clear as i,loadHistory as a}from"./memoria-CWArDp7u.js";import"./wii-CcEgf76L.js";import{SUGERENCIAS as o,detectarTema as s,generate as c,getSugerencias as l}from"./orar-BkBbrnNB.js";var u=()=>{let e=o.general,n=t().replace(/, $/,``).toLowerCase();return`
<div class="miia">
...
</div>`},d=!1,f=0,p=null,m=()=>({$msg:e(`#miiaMessages`),$inp:e(`#miiaInput`),$btn:e(`#miiaSend`)}),h=(t=!1)=>{let n=e(`#miiaMessages`)[0];n&&(t?n.scrollTo({top:n.scrollHeight,behavior:`smooth`}):n.scrollTop=n.scrollHeight)},g=async()=>p??=await n(()=>import(`./brain-D4yAOUQw.js`),[]),_=(t,n)=>{let{$msg:r}=m(),i=new Date().toLocaleTimeString(`es-PE`,{hour:`2-digit`,minute:`2-digit`}),a=e(`
