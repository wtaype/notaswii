import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,a as n,g as r,h as i,i as a,m as o,p as s,v as c}from"./widev-BLqPD_AU.js";import{t as l}from"./wii-IZM0MjcA.js";import{t as u}from"./preload-helper-DbWsiEEd.js";var d=`word_docs`,f=()=>`wd`+Date.now(),p={get:()=>{try{return JSON.parse(localStorage.getItem(d)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(d,JSON.stringify(e))},m=()=>!!s(`wd_sync`),h=()=>o(`wd_sync`,1,168),g=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
