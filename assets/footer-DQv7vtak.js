import{t as e}from"./vendor-BDh6mtVu.js";import{c as t,n,s as r,t as i}from"./wii-BOG14u5H.js";import{h as a}from"./widev-DTlDEmBw.js";function o(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
          <span class="foo_app">${i}</span>
          <span class="foo_ver">v14</span>
        </div>
        <div class="foo_links">
  ...
  `}e(`body`).append(o()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`),e(`body`).append(`
...
</nav>`);var s=()=>setTimeout(()=>{e(`.movil_logo`).html(e(`.wilogo`).html()||`<i class="fa-solid fa-book-open"></i> NotasWii`),e(`.movil_nav`).html(`${e(`.winav`).html()||``}${e(`.nv_right`).html()||``}`)},50);a.on(s),e(s),e(document).on(`click`,`.wimenu`,()=>e(`body`).addClass(`movil_open`)),e(document).on(`click`,`.movil_close, .movil_overlay, .movil_nav .nv_item, .movil_nav button`,()=>e(`body`).removeClass(`movil_open`));export{o as footer};