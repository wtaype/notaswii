...
<div class="ini_wrap">
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <p class="ini_cta_autor" style="margin-top:2vh;">Creado con ❤️ por <a href="${o}" target="_blank" rel="noopener">${s}</a> · v11 © ${r()}</p>
    </div>
  </section>
