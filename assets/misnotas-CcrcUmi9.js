  ...
  <article class="mn_card" data-id="${e.id}" data-tipo="${e.tipo}" style="--bc:${t.color}" title="Clic para editar">
    ...
    <div class="mn_card_top">
      ...
      <div class="mn_card_acts">
        <button class="mn_act mn_act_copy" data-id="${e.id}" ${n(`Copiar`)}><i class="fas fa-copy"></i></button>
        <button class="mn_act mn_act_del"  data-id="${e.id}" ${n(`Eliminar`,``,`error`)}><i class="fas fa-trash"></i></button>
      </div>
    </div>
  ...
  <div class="mn_header">
    ...
    <div class="mn_header_right">
      ...
      <div class="mn_filtros" id="mn_filtros">
        <button class="mn_filtro active" data-tipo="todas" ${n(`Todas`)}><i class="fas fa-layer-group"></i></button>
        ${Object.entries(f).map(([e,t])=>`<button class="mn_filtro" data-tipo="${e}" style="--fc:${t.color}" ${n(t.label)}><i class="fas ${t.icon}"></i></button>`).join(``)}
      </div>
    </div>
  </div>
  ...
  <div class="mn_layout">
    <aside class="mn_panel" id="mn_panel">
      <div class="mn_panel_head">
        ...
        <button class="mn_panel_new" id="mn_panel_new" ${n(`Nueva nota`)}>Nuevo <i class="fas fa-plus"></i></button>
      </div>
      <div class="mn_form" id="mn_form">
        <div class="mn_tipo_sel" id="mn_tipo_sel">
          ${Object.entries(f).map(([e,t])=>`<button class="mn_tipo_btn ${e===`idea`?`active`:``}" data-tipo="${e}" style="--tc:${t.color}" ${n(t.label)}><i class="fas ${t.icon}"></i> ${t.label}</button>`).join(``)}
        </div>
