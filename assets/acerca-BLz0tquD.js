        ...
        <section class="ac_card">
          ...
          <div class="ac_card_body ac_text_content">
            ...
            <div class="ac_firma">
              ...
              <a href="${r}" target="_blank" rel="noopener"><strong>${a}</strong></a>
              <span class="ac_year">${t()}</span>
            </div>
          </div>
        </section>
          ...
          <div class="ac_stats_grid">
            ${s.map(e=>`
              <div class="ac_stat_item">
                <strong data-target="${e.num.replace(/\D/g,``)}">${e.num}</strong>
                <span>${e.label}</span>
              </div>
            `).join(``)}
          </div>
