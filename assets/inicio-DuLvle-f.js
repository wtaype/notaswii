...
<div class="ini_wrap">
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <p class="ini_cta_autor" style="margin-top:2vh;">Creado con ❤️ por <a href="${n}" target="_blank" rel="noopener">${r}</a> · v14 © ${a()}</p>
    </div>
  </section>

</div>`,v=()=>{let e=0,n=t(`.ini_role`);setInterval(()=>{n.removeClass(`active`),n.eq(e=(e+1)%n.length).addClass(`active`)},2800),c(`#in_stats`,()=>{t(`.ini_stat_n`).each(function(){let e=t(this),n=+e.data(`target`),r=e.data(`sufijo`)||``,i=0,a=setInterval(()=>{i+=n/50,i>=n?(e.text(n+r),clearInterval(a)):e.text(Math.floor(i))},28)})}),c(`.ini_cat_card`,null,{anim:`wi_fadeUp`,stagger:80}),c(`.ini_about_card`,null,{anim:`wi_fadeUp`,stagger:140}),console.log(`🚀 ${i} v14 · Inicio OK`)},y=()=>{};export{l as t};