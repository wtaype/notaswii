...
<div class="ini_wrap">
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <p class="ini_cta_autor" style="margin-top:2vh;">Creado con ❤️ por <a href="${s}" target="_blank" rel="noopener">${o}</a> · v13 © ${r()}</p>
    </div>
  </section>
