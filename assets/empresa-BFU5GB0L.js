...
import{t as e}from"./vendor-BDh6mtVu.js";import{a as t,f as n,l as r,p as i,r as a,s as o,t as s,u as c}from"./widev-CHrYgt0x.js";import"./wii-Ca7PnfLv.js";import{t as l}from"./preload-helper-D8R59StC.js";import{E as u,_ as d,b as f,v as p,w as m,x as h}from"./firebase-CU10hIs1.js";import{n as g}from"./firebase-C44YYj9C.js";var _=()=>n(`wiSmile`),v=`epTotalEmpleados`,y=`epTotalEquipos`,b=`epMetricas`,x=`epFeed`,S=async()=>{let e=_();if(!e)return`<div class="epd_page"><div class="epd_empty"><i class="fas fa-lock"></i><p>Sin sesión activa.</p></div></div>`;let i=a(e.nombres||e.nombre||`Administrador`),c=o(e.nombres||e.nombre||``),l=e.foto||null,u=s(e.empresa||`NotasWii`),d=n(v)??`—`,f=n(y)??`—`,p=n(b)||{wpm:`—`,cert:`—`};return`
  <div class="epd_page">
