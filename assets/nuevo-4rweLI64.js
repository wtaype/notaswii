...
import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,b as n,f as r,h as i,i as a,n as o,v as s}from"./widev-DRhaZoqv.js";import{a as c,r as l}from"./wii-BL3abZT3.js";import{t as u}from"./preload-helper-DbWsiEEd.js";import{A as d,C as f,D as p,E as m,S as h,_ as g,b as _,g as v,v as y,x as b}from"./firebase-CCUuWaKQ.js";import{n as x}from"./firebase-Csc0LBnf.js";import{COL as S,clearBlogCache as C,clearPostCache as w,getPost as T}from"./devblog-C4nGPPqK.js";var E=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),D=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},O=()=>s.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,k=()=>{let e=i.user?.usuario?i.user:r(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let n=O();return`
  <div class="nu_wrap">
    <div class="nu_head">
