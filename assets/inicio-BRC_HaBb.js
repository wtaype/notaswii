...
<div class="ini_wrap">
  ...
  <section class="ini_hero">
    ...
    <div class="ini_hero_visual">
      ...
      <div class="ini_ftech ini_ft1" style="--d:.5s"  ${o(`Notas`)}><i class="fas fa-note-sticky"></i></div>
      <div class="ini_ftech ini_ft2" style="--d:.65s" ${o(`Word`)}><i class="fas fa-pen-to-square"></i></div>
      <div class="ini_ftech ini_ft3" style="--d:.8s"  ${o(`Flash`)}><i class="fas fa-bolt"></i></div>
      <div class="ini_ftech ini_ft4" style="--d:.95s" ${o(`Tareas`)}><i class="fas fa-tasks"></i></div>
    </div>
  </section>
  ...
  <section class="ini_about_sec">
    <div class="ini_sec_head">
      <h2 class="ini_sec_tit">¿Por qué usar <span class="ini_grad">${i}?</span></h2>
      <div class="ini_sec_line"></div>
    </div>
  ...
  <section class="ini_cta_sec">
    <div class="ini_cta_wrap">
      ...
      <div class="ini_cta_chips">
        <a href="/login" class="ini_btn_p"><i class="fas fa-arrow-right"></i> Entrar a ${i}</a>
      </div>
      <p class="ini_cta_autor" style="margin-top:2vh;">Creado con ❤️ por <a href="${n}" target="_blank" rel="noopener">${r}</a> · v15 © ${a()}</p>
    </div>
  </section>

</div>`,v=()=>{let e=0,n=t(`.ini_role`);setInterval(()=>{n.removeClass(`active`),n.eq(e=(e+1)%n.length).addClass(`active`)},2800),c(`#in_stats`,()=>{t(`.ini_stat_n`).each(function(){let e=t(this),n=+e.data(`target`),r=e.data(`sufijo`)||``,i=0,a=setInterval(()=>{i+=n/50,i>=n?(e.text(n+r),clearInterval(a)):e.text(Math.floor(i))},28)})}),c(`.ini_cat_card`,null,{anim:`wi_fadeUp`,stagger:80}),c(`.ini_about_card`,null,{anim:`wi_fadeUp`,stagger:140}),console.log(`🚀 ${i} v15 · Inicio OK`)},y=()=>{};export{l as t};