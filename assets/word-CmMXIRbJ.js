import{t as e}from"./vendor-BDh6mtVu.js";import{_ as t,a as n,f as r,h as i,i as a,m as o,p as s,x as c}from"./widev-DghgRcN4.js";import{t as l}from"./wii-Ce1IXd2j.js";import{t as u}from"./preload-helper-DbWsiEEd.js";var d=`word_docs`,f=()=>`wd`+Date.now(),p=[{id:`ej1`,titulo:`Documento de Ejemplo`,contenido:`<p>Este es un documento de ejemplo. <b>Prueba a editar el texto</b> y usar las herramientas de la barra superior para darle estilo.</p>`,pin:!0,creado:Date.now(),actualizado:Date.now(),synced:!1}],m={get:()=>{let e=localStorage.getItem(d);return e===null&&!i.user?[...p]:r(d)||(e?.startsWith(`[`)?JSON.parse(e):[])},set:e=>s(d,e,8760)},h=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
  ...
  <div class="wd_workspace">
    ...
    <aside id="wd_sidebar" class="wd_sidebar">
      ...
      <div class="wd_sb_head">
        ...
        <div style="display:flex; gap: 5px;">
          <button id="wd_btn_refresh" class="wd_sb_btn" style="display:none" ${c(`Actualizar`)}><i class="fas fa-rotate-right"></i></button>
...
</div>`,g=async()=>{let{db:e}=await u(async()=>{let{db:e}=await import(`./firebase-CCwEX8XK.js`).then(e=>e.r);return{db:e}},[]);return{db:e,...await u(()=>import(`./firebase-CCUuWaKQ.js`).then(e=>e.f),[])}},_=async e=>{let t=i.user;if(t?.email)try{let{db:n,doc:r,setDoc:i,serverTimestamp:a}=await g();await i(r(n,`word`,e.id),{id:e.id,usuario:t.usuario||t.email,email:t.email,titulo:String(e.titulo||``),contenido:String(e.contenido||``),pin:!!e.pin,creado:a(),actualizado:a()})}catch(e){console.error(`[word] guardarNube:`,e)}},v=async e=>{let t=i.user;if(t?.email)try{let{db:n,doc:r,setDoc:i,serverTimestamp:a}=await g();await i(r(n,`word`,e.id),{id:e.id,usuario:t.usuario||t.email,email:t.email,titulo:String(e.titulo||``),contenido:String(e.contenido||``),pin:!!e.pin,actualizado:a()},{merge:!0})}catch(e){console.error(`[word] actualizarNube:`,e)}},y=async e=>{if(i.user?.email)try{let{db:t,doc:n,deleteDoc:r}=await g();await r(n(t,`word`,e))}catch{}},b=async()=>{let e=i.user;if(!e?.email)return null;try{let{db:t,collection:n,getDocs:r,query:i,where:a}=await g();return(await r(i(n(t,`word`),a(`email`,`==`,e.email)))).docs.map(e=>{let t=e.data();return{id:e.id,titulo:t.titulo||``,contenido:t.contenido||``,pin:!!t.pin,creado:t.creado?.toMillis?.()||Date.now(),actualizado:t.actualizado?.toMillis?.()||Date.now(),synced:!0}})}catch{return null}},x=e=>{let t=document.createElement(`div`);return t.innerHTML=e||``,t.textContent||t.innerText||``},S=(e,t)=>{let n=x(e.contenido),r=n.length>50?n.substring(0,50)+`...`:n||`Sin contenido...`,i=e.id===t?`active`:``,a=e.titulo||`Documento sin título`;return`
    <div class="wd_doc_item ${i}${e.pin?` wd_pinned`:``}" data-id="${e.id}">
      ...
      <p>${r}</p>
    </div>`},C=null,w=async()=>{let r=m.get(),s=null,c=null;i.user&&e(`#wd_saludo`).text(`${n()}${i.user.nombre||i.user.usuario}`);let u=()=>e(`#wd_sb_list`).html(`<div class="wd_skeleton"></div>`.repeat(3)),p=()=>[...r].sort((e,t)=>e.pin&&!t.pin?-1:!e.pin&&t.pin?1:(t.actualizado||0)-(e.actualizado||0)),h=async()=>{let e=p();await t(`#wd_sb_list`,e.length?e.map(e=>S(e,s?.id)).join(``):`<div class="wd_empty">No tienes documentos. Crea uno nuevo.</div>`,80)},g=t=>{s=t,e(`#wd_in_tit`).val(t.titulo||``),e(`#wd_editor`).html(t.contenido||``),h()},w=()=>{r=r.filter(e=>!e.id.startsWith(`ej`));let t={id:f(),titulo:``,contenido:``,pin:!1,creado:Date.now(),actualizado:Date.now(),synced:!1};r.unshift(t),m.set(r),g(t),setTimeout(()=>{e(`#wd_editor`).focus(),document.execCommand(`fontName`,!1,`'Segoe UI', system-ui`)},50)},T=()=>{if(!s)return;s.titulo=e(`#wd_in_tit`).val().trim(),s.contenido=e(`#wd_editor`).html(),s.actualizado=Date.now(),m.set(r);let t=e(`#wd_sb_list .wd_doc_item[data-id="${s.id}"]`);if(t.length){t.find(`h4`).text(s.titulo||`Documento sin título`);let e=x(s.contenido);t.find(`p`).text(e.length>50?e.substring(0,50)+`...`:e||`Sin contenido...`),t.find(`.fa-cloud.wd_cloud_ok`).removeClass(`fa-cloud wd_cloud_ok`).addClass(`fa-cloud-arrow-up wd_cloud_pen`).attr(`data-witip`,`Local (Cambios sin guardar)`)}},E=()=>{e(`.wd_btn_tool[data-cmd]`).each(function(){try{e(this).toggleClass(`active`,document.queryCommandState(e(this).data(`cmd`)))}catch{}});try{let t=window.getSelection();if(!t.anchorNode)return;let n=t.anchorNode.nodeType===3?t.anchorNode.parentNode:t.anchorNode;if(e(n).closest(`.wd_editor`).length){let t=window.getComputedStyle(n);if(t.fontSize&&e(`#wd_f_sz`).val(parseInt(t.fontSize)),t.fontFamily){let n=t.fontFamily.split(`,`)[0].replace(/['"]/g,``);e(`#wd_f_fam option`).filter(function(){return e(this).text()===n||e(this).val().includes(n)}).prop(`selected`,!0)}let r=e(n).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);r.length&&r[0].style.lineHeight&&e(`#wd_l_ht`).val(r[0].style.lineHeight)}}catch{}};e(document).on(`click`,`#wd_btn_menu`,()=>e(`#wd_sidebar`).toggleClass(`closed`)).on(`click`,`#wd_btn_new`,w).on(`click`,`#wd_btn_refresh`,async function(){let t=e(this).find(`i`);if(t.hasClass(`wd_spin`))return;t.addClass(`wd_spin`);let n=await b();n&&(r=n,m.set(r),r.length?g(p()[0]):w(),a(`Sincronizado ✓`,`success`)),t.removeClass(`wd_spin`)}).on(`click`,`.wd_doc_item`,function(t){if(e(t.target).closest(`.wd_doc_acts`).length)return;let n=r.find(t=>t.id===e(this).data(`id`));n&&n.id!==s?.id&&g(n)}).on(`click`,`.wd_btn_del_doc`,function(){!s||!confirm(`¿Eliminar este documento permanentemente?`)||(r=r.filter(e=>e.id!==s.id),m.set(r),i.user&&s.synced&&y(s.id),a(`Documento eliminado`,`success`),r.length?g(p()[0]):w())}).on(`click`,`#wd_btn_save`,function(){if(!s)return;T();let t=s.titulo||x(s.contenido).trim().length>0;if(i.user&&t){let t=e(this).find(`i`).removeClass(`fa-save`).addClass(`fa-spinner wd_spin`);(s.synced?v(s):_(s)).then(()=>{s.synced=!0,m.set(r),e(`#wd_sb_list .wd_doc_item[data-id="${s.id}"] .fa-cloud-arrow-up`).removeClass(`fa-cloud-arrow-up wd_cloud_pen`).addClass(`fa-cloud wd_cloud_ok`).attr(`data-witip`,`En nube`),t.removeClass(`fa-spinner wd_spin`).addClass(`fa-save`),a(`¡Guardado con éxito! ☁️`,`success`)}).catch(()=>{t.removeClass(`fa-spinner wd_spin`).addClass(`fa-save`),a(`Error al guardar en la nube`,`error`)})}else i.user&&!t?a(`Agrega un título o contenido primero`,`warning`):a(`Guardado localmente ✓`,`success`)}).on(`click`,`.wd_act_pin`,function(t){t.stopPropagation();let n=e(this).data(`id`),a=r.find(e=>e.id===n);a&&(a.pin=!a.pin,m.set(r),h(),i.user&&a.synced&&v(a))}).on(`input`,`#wd_editor`,()=>{E(),T()}).on(`input`,`#wd_in_tit`,T).on(`mouseup keyup`,`#wd_editor`,function(){E();let e=window.getSelection();e.rangeCount>0&&(c=e.getRangeAt(0))}).on(`click`,`.wd_btn_tool[data-cmd]`,function(t){t.preventDefault(),document.execCommand(e(this).data(`cmd`),!1,null),E(),e(`#wd_editor`).focus()}).on(`change`,`#wd_f_fam`,function(){if(c){let e=window.getSelection();e.removeAllRanges(),e.addRange(c)}document.execCommand(`styleWithCSS`,!1,!0),document.execCommand(`fontName`,!1,e(this).val()),e(`#wd_editor`).focus().trigger(`input`)}).on(`keydown`,`#wd_f_sz`,function(t){if(t.key!==`Enter`)return;t.preventDefault();let n=Math.max(8,Math.min(100,parseInt(e(this).val())||16));if(e(this).val(n),c){let e=window.getSelection();e.removeAllRanges(),e.addRange(c)}document.execCommand(`styleWithCSS`,!1,!0),document.execCommand(`fontSize`,!1,`7`),e(`.wd_editor font[size="7"], .wd_editor span[style*="xxx-large"]`).removeAttr(`size`).css(`font-size`,n+`px`),e(`#wd_editor`).focus().trigger(`input`)}).on(`change`,`#wd_l_ht`,function(){if(c){let e=window.getSelection();e.removeAllRanges(),e.addRange(c)}let t=window.getSelection();if(t.rangeCount){let n=t.getRangeAt(0).commonAncestorContainer,r=n.nodeType===3?n.parentNode:n,i=e(r).hasClass(`wd_editor`)?e(r).children().filter(function(){return t.containsNode(this,!0)}):e(r).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);!i.length&&e(r).hasClass(`wd_editor`)&&(i=e(r)),i.css(`line-height`,e(this).val())}e(`#wd_editor`).focus().trigger(`input`)}).on(`input`,`#wd_c_txt`,function(){document.execCommand(`foreColor`,!1,e(this).val()),e(`#wd_editor`).focus()}).on(`input`,`#wd_c_bg`,function(){document.execCommand(`hiliteColor`,!1,e(this).val()),e(`#wd_editor`).focus()}),o([`.wd_ribbon`,`.wd_sidebar`,`.wd_page`],50),r.length?g(p()[0]):w(),C=i.on(async t=>{e(`#wd_btn_refresh`).toggle(!!t),t?(e(`#wd_saludo`).text(`${n()}${t.nombre||t.usuario}`),r.length===0&&u(),r=await b()||[],m.set(r),r.length?g(p()[0]):w()):(e(`#wd_saludo`).text(`Archivos`),localStorage.removeItem(d),r=m.get(),r.length?g(p()[0]):w())}),console.log(`📝 ${l} v13 · Word OK`)},T=()=>{e(document).off(`click input mouseup keyup change keydown`,`#wd_btn_menu, #wd_btn_new, #wd_btn_refresh, .wd_doc_item, .wd_btn_del_doc, #wd_btn_save, .wd_act_pin, #wd_editor, #wd_in_tit, .wd_btn_tool, #wd_f_fam, #wd_f_sz, #wd_l_ht, #wd_c_txt, #wd_c_bg`),C?.()};export{T as cleanup,w as init,h as render};