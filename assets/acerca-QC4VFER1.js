      ...
      <div class="ac_dcol">
        ...
        <section class="ac_card">
          ...
          <div class="ac_card_body ac_text_content">
            <p><strong>${i}</strong> nació de una necesidad real: capturar ideas al vuelo sin fricciones. Las herramientas tradicionales exigen demasiados clics; nosotros elegimos la inmediatez.</p>
            ...
            <div class="ac_firma">
              ...
              <a href="${t}" target="_blank" rel="noopener"><strong>${r}</strong></a>
              <span class="ac_year">${a()}</span>
            </div>
          </div>
        </section>
...
`,d=()=>{e(`.ac_counter`).each(function(){let t=e(this),n=t.data(`target`);if(!n)return;let r=parseInt(n),i=t.text().replace(/[0-9]/g,``),a=null,o=e=>{a||=e;let n=Math.min((e-a)/1500,1),s=1-(1-n)**3,c=Math.floor(s*r);t.text(c+(n>=1?i:``)),n<1&&requestAnimationFrame(o)};requestAnimationFrame(o)})},f=()=>{setTimeout(d,300),e(`#ac_compartir`).on(`click`,function(){let e=`https://notaswii.web.app/`;navigator.share?navigator.share({title:i,text:`✍️ ${i} — Ecosistema de productividad.`,url:e}).catch(()=>{}):o(e,this,`¡Link copiado!`)}),console.log(`📝 ${i} v14 · Acerca (Compact Pro)`)},p=()=>{e(`#ac_compartir`).off(`click`)};export{p as cleanup,f as init,u as render};