...
<div class="ini_wrap">
  ...
  <section class="ini_hero">
    ...
    <div class="ini_hero_visual">
      ...
      <div class="ini_ftech ini_ft1" style="--d:.5s"  ${i(`Notas`)}><i class="fas fa-note-sticky"></i></div>
      <div class="ini_ftech ini_ft2" style="--d:.65s" ${i(`Word`)}><i class="fas fa-pen-to-square"></i></div>
      <div class="ini_ftech ini_ft3" style="--d:.8s"  ${i(`Flash`)}><i class="fas fa-bolt"></i></div>
      <div class="ini_ftech ini_ft4" style="--d:.95s" ${i(`Tareas`)}><i class="fas fa-tasks"></i></div>
    </div>
  </section>
