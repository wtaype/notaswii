import{t as e}from"./vendor-BDh6mtVu.js";import{i as t,m as n,p as r}from"./widev-BLqPD_AU.js";import{t as i}from"./wii-IZM0MjcA.js";import{E as a,h as o,w as s,x as c}from"./firebase-CCUuWaKQ.js";import{n as l}from"./firebase-BNeWaP4M.js";var u=()=>r(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let t=u();!t||t.rol!==`admin`||(e(document).off(`.am`),v(),y(),e(document).on(`click.am`,`#am_btn_refresh`,function(){let t=e(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>t.removeClass(`fa-spin`),500)})}))},_=()=>{e(document).off(`.am`)};function v(){e(`#am_n_total`).text(r(d)||`—`),e(`#am_n_pro`).text(r(f)||`—`),e(`#am_n_org`).text(r(p)||`—`),e(`#am_n_les`).text(r(m)||`45`)}async function y(i=!1){try{let u=a(l,`smiles`);if(i||!r(d)){let t=(await o(u)).data().count;n(d,t),e(`#am_n_total`).text(t)}if(i||!r(f)){let t=(await o(c(u,s(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;n(f,t),e(`#am_n_pro`).text(t)}if(i||!r(p)){let t=(await o(c(u,s(`rol`,`==`,`empresa`)))).data().count;n(p,t),e(`#am_n_org`).text(t)}i&&t(`Estadísticas sincronizadas`,`success`)}catch(e){console.error(`[Admin] Error cargando stats:`,e),i&&t(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};