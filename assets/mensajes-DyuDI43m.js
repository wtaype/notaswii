import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,a as n,f as r,i,w as a}from"./widev-DRhaZoqv.js";import{t as o}from"./wii-BA2rwkUR.js";import{n as s}from"./rutas-BSJDfNPX.js";import{A as c,D as l,E as u,S as d,_ as f,m as p,v as m,w as h,x as g}from"./firebase-CCUuWaKQ.js";import{n as _,t as v}from"./firebase-Cm7xKT09.js";var y=[],b=null,x=!1,S=null,C=null,w=`wi_mensajes_cache`,T=50,E=()=>r(`wiSmile`)||{},D=e=>{try{localStorage.setItem(w,JSON.stringify(e))}catch{}},O=()=>{try{return JSON.parse(localStorage.getItem(w)||`[]`)}catch{return[]}},k=()=>{let e=document.getElementById(`wmChat`);e&&requestAnimationFrame(()=>e.scrollTop=e.scrollHeight)},A=()=>{let e=E();if(!e.email)return location.replace(`/`),``;let r=e.nombre||e.usuario||e.email||v.currentUser?.email||``;return`
