import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,f as n,g as r,n as i,p as a,w as o}from"./widev-DRhaZoqv.js";import{n as s}from"./rutas-CZaaHOFI.js";import{C as c,D as l,u}from"./firebase-CCUuWaKQ.js";import{n as d,t as f}from"./firebase-CCwEX8XK.js";var p=()=>n(`wiSmile`)||{},m=()=>{let e=p();if(!e.email)return location.replace(`/`),``;let n=e.nombre||``,i=e.apellidos||``,a=e.usuario||``,o=e.email||``,s=e.rol||`smile`,c=e.plan||`free`,l=e.estado||`activo`,u=(e.tema||`Por defecto`).split(`|`)[0],d=e.uid||``,f=e.avatar||``,m=e.fechaNacimiento||``,h=e.pais||``,g=e.genero||``,_=e.gustos||``,v=e.creado?r(null).get(e.creado,`local`):`Desconocido`,y=`https://ui-avatars.com/api/?name=`+encodeURIComponent(n+` `+i)+`&background=random&color=fff`;return`
  <div class="prf_wrap">
