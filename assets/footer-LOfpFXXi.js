import{t as e}from"./vendor-BDh6mtVu.js";import{h as t}from"./widev-CHrYgt0x.js";import{c as n,n as r,s as i,t as a}from"./wii-Ca7PnfLv.js";function o(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
  ...
  `}e(`body`).append(o()),e(`head`).append(`<style>:root{--bgim:url("/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`),e(`body`).append(`
