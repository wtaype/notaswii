    ...
    <div class="ac_cta_wrap wi_fadeUp">
      ...
      <div class="ac_cta_inner">
        ...
        <p class="ac_footer_txt">
          ${c} v9 · Hecho con <i class="fas fa-heart"></i> por
