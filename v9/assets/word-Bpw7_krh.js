import{t as e}from"./vendor-BDh6mtVu.js";import{g as t,h as n,i as r}from"./widev-vc3w_AsM.js";import{t as i}from"./preload-helper-TQeha_t2.js";var a=`word_docs`,o=()=>{try{return JSON.parse(localStorage.getItem(a)||`[]`)}catch{return[]}},s=e=>localStorage.setItem(a,JSON.stringify(e)),c=()=>Date.now().toString(36)+Math.random().toString(36).slice(2,6),l=()=>`
<div class="wd_wrap">
