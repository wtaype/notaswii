import{t as e}from"./vendor-BDh6mtVu.js";import{c as t,n,s as r,t as i}from"./wii-DEYC667F.js";function a(){let e=new Date;return`
  ...
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/v9/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
