import{t as e}from"./vendor-BDh6mtVu.js";import{g as t,h as n,i as r,w as i}from"./widev-vc3w_AsM.js";import{t as a}from"./preload-helper-TQeha_t2.js";var o=`links`,s=()=>{try{return JSON.parse(localStorage.getItem(o)||`[]`)}catch{return[]}},c=e=>localStorage.setItem(o,JSON.stringify(e)),l=()=>Date.now().toString(36)+Math.random().toString(36).slice(2,6),u=e=>{try{let t=new URL(e).hostname;return t=t.replace(`www.`,``),t.split(`.`)[0]||`Enlace`}catch{return`Enlace Web`}},d=()=>`
<div class="lk_wrap">
  <div class="lk_hero">
