import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,a as n,g as r,h as i,i as a,m as o,p as s,v as c,w as l}from"./widev-BY9EW4md.js";import{t as u}from"./wii-IZM0MjcA.js";import{t as d}from"./preload-helper-CwAw_xRM.js";var f=`flash`,p=()=>`fl`+Date.now(),m={get:()=>{try{return JSON.parse(localStorage.getItem(f)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(f,JSON.stringify(e))},h=()=>!!s(`fl_sync`),g=()=>o(`fl_sync`,1,168),_=e=>{let t=Math.floor((Date.now()-e)/1e3);if(t<60)return`Justo ahora`;let n=Math.floor(t/60);if(n<60)return`Hace ${n} min`;let r=Math.floor(n/60);return r<24?`Hace ${r}h`:new Date(e).toLocaleDateString(`es-PE`,{day:`2-digit`,month:`short`})},v=({id:e,pin:n,synced:r,creado:i,contenido:a})=>`
