import{t as e}from"./vendor-BDh6mtVu.js";import{c as t,n,s as r,t as i}from"./wii-IZM0MjcA.js";function a(){let e=new Date;return`
  <footer class="foo wb txc psa">
    <span>Creado con <i class="fas fa-heart"></i> by <a class="ftx lkme" href="${t}" target="_blank">${n}</a></span>
    <span>${r} - <span class="wty">${e.getFullYear()}</span></span>
    <span class="abw"> | ${i} v10 | actualizado:
    <span class="wtu">${e.toLocaleString()}</span></span>
  </footer>
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/v10/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`);var o=()=>`${e(`.nv_right`).html()}`;e(`body`).append(`<div class="movil_overlay"></div>
