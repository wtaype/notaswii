import{t as e}from"./vendor-BDh6mtVu.js";import{S as t,a as n,g as r,h as i,i as a,m as o,p as s,v as c}from"./widev-BY9EW4md.js";import{t as l}from"./wii-IZM0MjcA.js";import{t as u}from"./preload-helper-CwAw_xRM.js";var d=`word_docs`,f=()=>`wd`+Date.now(),p={get:()=>{try{return JSON.parse(localStorage.getItem(d)||`[]`)}catch{return[]}},set:e=>localStorage.setItem(d,JSON.stringify(e))},m=()=>!!s(`wd_sync`),h=()=>o(`wd_sync`,1,168),g=()=>`
<div class="wd_wrap">
  <!-- RIBBON -->
  ...
  <div class="wd_workspace">
    ...
    <aside id="wd_sidebar" class="wd_sidebar">
      ...
      <div class="wd_sb_head">
        ...
        <div style="display:flex; gap: 5px;">
          <button id="wd_btn_refresh" class="wd_sb_btn" ${t(`Actualizar`)}><i class="fas fa-rotate-right"></i></button>
    ...
    <div class="wd_doc_item ${a}${e.pin?` wd_pinned`:``}" data-id="${e.id}">
      ...
      <p>${i}</p>
    </div>`},w=async()=>{let t=p.get(),o=null,s=null;r.logged&&e(`#wd_saludo`).text(`${n()}${r.user.nombre||r.user.usuario}`);let u=()=>e(`#wd_sb_list`).html(`<div class="wd_skeleton"></div>`.repeat(3)),d=()=>[...t].sort((e,t)=>e.pin&&!t.pin?-1:!e.pin&&t.pin?1:(t.actualizado||0)-(e.actualizado||0)),g=async()=>{let e=d();await c(`#wd_sb_list`,e.length?e.map(e=>C(e,o?.id)).join(``):`<div class="wd_empty">No tienes documentos. Crea uno nuevo.</div>`,80)},_=t=>{o=t,e(`#wd_in_tit`).val(t.titulo||``),e(`#wd_editor`).html(t.contenido||``),g()},w=()=>{let n={id:f(),titulo:``,contenido:``,pin:!1,creado:Date.now(),actualizado:Date.now(),synced:!1};t.unshift(n),p.set(t),_(n),setTimeout(()=>{e(`#wd_editor`).focus(),document.execCommand(`fontName`,!1,`'Segoe UI', system-ui`)},50)},T=async(n=!1)=>{if(!r.logged)return;n&&u();let i=e(`#wd_btn_refresh i`).addClass(`wd_spin`);try{let e=await x();if(e?.length){let n=new Set(e.map(e=>e.id)),r=t.filter(e=>!n.has(e.id));r.forEach(e=>{(e.contenido||e.titulo)&&v(e)}),t=[...e,...r],p.set(t),h()}}finally{i.removeClass(`wd_spin`),t.length&&!o?_(d()[0]):t.length?g():w()}},E=()=>{if(!o)return;o.titulo=e(`#wd_in_tit`).val().trim(),o.contenido=e(`#wd_editor`).html(),o.actualizado=Date.now(),p.set(t);let n=e(`#wd_sb_list .wd_doc_item[data-id="${o.id}"]`);if(n.length){n.find(`h4`).text(o.titulo||`Documento sin título`);let e=S(o.contenido);n.find(`p`).text(e.length>50?e.substring(0,50)+`...`:e||`Sin contenido...`),n.find(`.fa-cloud.wd_cloud_ok`).removeClass(`fa-cloud wd_cloud_ok`).addClass(`fa-cloud-arrow-up wd_cloud_pen`).attr(`data-witip`,`Local (Cambios sin guardar)`)}},D=()=>{e(`.wd_btn_tool[data-cmd]`).each(function(){try{e(this).toggleClass(`active`,document.queryCommandState(e(this).data(`cmd`)))}catch{}});try{let t=window.getSelection();if(!t.anchorNode)return;let n=t.anchorNode.nodeType===3?t.anchorNode.parentNode:t.anchorNode;if(e(n).closest(`.wd_editor`).length){let t=window.getComputedStyle(n);if(t.fontSize&&e(`#wd_f_sz`).val(parseInt(t.fontSize)),t.fontFamily){let n=t.fontFamily.split(`,`)[0].replace(/['"]/g,``);e(`#wd_f_fam option`).filter(function(){return e(this).text()===n||e(this).val().includes(n)}).prop(`selected`,!0)}let r=e(n).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);r.length&&r[0].style.lineHeight&&e(`#wd_l_ht`).val(r[0].style.lineHeight)}}catch{}};e(document).on(`click`,`#wd_btn_menu`,()=>e(`#wd_sidebar`).toggleClass(`closed`)).on(`click`,`#wd_btn_new`,w).on(`click`,`#wd_btn_refresh`,()=>T(!0)).on(`click`,`.wd_doc_item`,function(n){if(e(n.target).closest(`.wd_doc_acts`).length)return;let r=t.find(t=>t.id===e(this).data(`id`));r&&r.id!==o?.id&&_(r)}).on(`click`,`.wd_btn_del_doc`,function(){!o||!confirm(`¿Eliminar este documento permanentemente?`)||(t=t.filter(e=>e.id!==o.id),p.set(t),r.logged&&o.synced&&b(o.id),a(`Documento eliminado`,`success`),t.length?_(d()[0]):w())}).on(`click`,`#wd_btn_save`,function(){if(!o)return;E();let n=o.titulo||S(o.contenido).trim().length>0;if(r.logged&&n){let n=e(this).find(`i`).removeClass(`fa-save`).addClass(`fa-spinner wd_spin`);(o.synced?y(o):v(o)).then(()=>{o.synced=!0,p.set(t),e(`#wd_sb_list .wd_doc_item[data-id="${o.id}"] .fa-cloud-arrow-up`).removeClass(`fa-cloud-arrow-up wd_cloud_pen`).addClass(`fa-cloud wd_cloud_ok`).attr(`data-witip`,`En nube`),n.removeClass(`fa-spinner wd_spin`).addClass(`fa-save`),a(`Guardado en la nube`,`success`)})}else a(`Guardado localmente`,`success`)}).on(`click`,`.wd_act_pin`,function(n){n.stopPropagation();let i=e(this).data(`id`),a=t.find(e=>e.id===i);a&&(a.pin=!a.pin,p.set(t),g(),r.logged&&a.synced&&y(a))}).on(`input`,`#wd_editor`,()=>{D(),E()}).on(`input`,`#wd_in_tit`,E).on(`mouseup keyup`,`#wd_editor`,function(){D();let e=window.getSelection();e.rangeCount>0&&(s=e.getRangeAt(0))}).on(`click`,`.wd_btn_tool[data-cmd]`,function(t){t.preventDefault(),document.execCommand(e(this).data(`cmd`),!1,null),D(),e(`#wd_editor`).focus()}).on(`change`,`#wd_f_fam`,function(){if(s){let e=window.getSelection();e.removeAllRanges(),e.addRange(s)}document.execCommand(`styleWithCSS`,!1,!0),document.execCommand(`fontName`,!1,e(this).val()),e(`#wd_editor`).focus().trigger(`input`)}).on(`keydown`,`#wd_f_sz`,function(t){if(t.key!==`Enter`)return;t.preventDefault();let n=Math.max(8,Math.min(100,parseInt(e(this).val())||16));if(e(this).val(n),s){let e=window.getSelection();e.removeAllRanges(),e.addRange(s)}document.execCommand(`styleWithCSS`,!1,!0),document.execCommand(`fontSize`,!1,`7`),e(`.wd_editor font[size="7"], .wd_editor span[style*="xxx-large"]`).removeAttr(`size`).css(`font-size`,n+`px`),e(`#wd_editor`).focus().trigger(`input`)}).on(`change`,`#wd_l_ht`,function(){if(s){let e=window.getSelection();e.removeAllRanges(),e.addRange(s)}let t=window.getSelection();if(t.rangeCount){let n=t.getRangeAt(0).commonAncestorContainer,r=n.nodeType===3?n.parentNode:n,i=e(r).hasClass(`wd_editor`)?e(r).children().filter(function(){return t.containsNode(this,!0)}):e(r).closest(`p, div, h1, h2, h3, h4, h5, h6, li`);!i.length&&e(r).hasClass(`wd_editor`)&&(i=e(r)),i.css(`line-height`,e(this).val())}e(`#wd_editor`).focus().trigger(`input`)}).on(`input`,`#wd_c_txt`,function(){document.execCommand(`foreColor`,!1,e(this).val()),e(`#wd_editor`).focus()}).on(`input`,`#wd_c_bg`,function(){document.execCommand(`hiliteColor`,!1,e(this).val()),e(`#wd_editor`).focus()}),i([`.wd_ribbon`,`.wd_sidebar`,`.wd_page`],50),t.length?(_(d()[0]),r.logged&&!m()&&T(!1)):r.logged?await T(!0):w(),console.log(`📝 ${l} v10 · Word OK`)},T=()=>{e(document).off(`click input mouseup keyup change keydown`,`#wd_btn_menu, #wd_btn_new, #wd_btn_refresh, .wd_doc_item, .wd_btn_del_doc, #wd_btn_save, .wd_act_pin, #wd_editor, #wd_in_tit, .wd_btn_tool, #wd_f_fam, #wd_f_sz, #wd_l_ht, #wd_c_txt, #wd_c_bg`)};export{T as cleanup,w as init,g as render};