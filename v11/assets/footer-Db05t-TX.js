import{t as e}from"./vendor-BDh6mtVu.js";import{h as t}from"./widev-B--4oPfx.js";import{n,s as r,t as i}from"./wii-By3LwGGz.js";function a(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
  ...
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/v11/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`),e(`body`).append(`
