import{t as e}from"./vendor-BDh6mtVu.js";import{b as t,f as n,i as r,x as i}from"./widev-Di7bYMvC.js";import{A as a,D as o,E as s,_ as c,m as l,p as u,w as d,x as f}from"./firebase-CCUuWaKQ.js";import{n as p,t as m}from"./firebase-CKMRR4tO.js";var h=`wiAudios`,g=`wiImg`,_=()=>n(`wiSmile`)?.email||m.currentUser?.email||``,v=async e=>{let t=_();return t?(await c(f(s(p,e),d(`email`,`==`,t)))).docs.map(e=>({id:e.id,...e.data()})).sort((e,t)=>(t.creado?.seconds||0)-(e.creado?.seconds||0)):[]},y=async(e,t,n)=>{let r=_();return r?(await u(s(p,e),{email:r,titulo:t,src:n,creado:a(),actualizado:a()})).id:null},b=async(e,t)=>{await l(o(p,e,t))},x=()=>v(h),S=()=>v(g),C=(e,t)=>`
