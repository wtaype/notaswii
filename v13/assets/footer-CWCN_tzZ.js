import{t as e}from"./vendor-BDh6mtVu.js";import{h as t}from"./widev-Di7bYMvC.js";import{n,s as r,t as i}from"./wii-DnBLd2G7.js";function a(){return`
  <footer class="foo">
    <div class="foo_inner">
      <div class="foo_left">
        <div class="foo_brand">
          <span class="foo_app">${i}</span>
          <span class="foo_ver">v12</span>
        </div>
        <div class="foo_links">
  ...
  `}e(`body`).append(a()),e(`head`).append(`<style>:root{--bgim:url("/notaswii/v13/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>`),e(`body`).append(`
