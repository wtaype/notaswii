...
import{t as e}from"./vendor-BDh6mtVu.js";import{C as t,S as n,h as r,i,x as a}from"./widev-Di7bYMvC.js";import{i as o,t as s}from"./wii-DnBLd2G7.js";import{t as c}from"./preload-helper-DK0U7nVd.js";import{addView as l,clearPostCache as u,clearRelCache as d,fade as f,getPost as p,getPreview as m,getRelacionados as h,superDate as g,tplShare as _}from"./devblog-CA193sAj.js";import{adRight as v}from"./wiad-FUv8aJVB.js";var y=e=>`<a href="/${e.slug}" class="po_rel_card" ${a(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-clock"></i> ${e.tiempo_lectura} · <i class="fas fa-eye"></i> ${e.vistas||0}</span></div></a>`,b=e=>{let t=e&&m(e);return t?`
      ...
      <div class="po_content">
        <div class="po_hero po_fade po_visible" style="--d:0s">
          ...
          <div class="po_hero_over">
            ...
            <div class="po_hero_badges"><span class="po_cat_badge" ${a(t.categoria)}><i class="fas fa-paw"></i> ${t.categoria}</span></div>
          </div>
        </div>
      ...
      <div class="po_wrap"><div class="po_layout">
        <div class="po_content">
          <div class="po_hero po_fade" style="--d:0s">
            ...
            <div class="po_hero_over">
              ...
              <div class="po_hero_badges">
                <span class="po_cat_badge" ${a(T.categoria)}><i class="fas fa-paw"></i> ${T.categoria}</span>
                ${T.destacado?`<span class="po_dest_badge" ${a(`Destacada`)}><i class="fas fa-star"></i> Destacado</span>`:``}
              </div>
            </div>
          </div>
          <header class="po_header po_fade" style="--d:.1s">
            ...
            <p class="po_resumen">${T.resumen}</p>
            <div class="po_meta">
              <span ${a(`Autor`)}><i class="fas fa-user-pen"></i> ${T.autor}</span>
              <span ${a(`Fecha`)}><i class="fas fa-calendar"></i> ${O}</span>
              <span ${a(`Lectura`)}><i class="fas fa-clock"></i> ${T.tiempo_lectura}</span>
              <span ${a(`Vistas`)}><i class="fas fa-eye"></i> ${A}</span>
              ${E?`<span class="po_cache_badge" ${a(`Cache ⚡`)}><i class="fas fa-bolt"></i></span>`:``}
            </div>
          </header>
          ...
          <div class="po_share po_fade" style="--d:.45s">
            ...
            <div class="po_share_btns">${_(T.titulo)}<button class="po_share_btn po_copy" style="--sc:var(--mco)" ${a(`Copiar`)}><i class="fas fa-link"></i></button></div>
          </div>
        </div>
        <aside class="po_sidebar">
          <div class="po_side_card po_fade" style="--d:.15s">
            ...
            <div class="po_autor_box"><div class="po_autor_av"><img src="/notaswii/v13/smile.avif" alt="${T.autor}"/></div><div class="po_autor_info"><strong>${T.autor}</strong><span>${s} <i class="fas ${o}"></i></span></div></div>
            ${j?`<div class="po_admin_actions" style="margin-top:.8vh"><a href="/nuevo?edit=${b}" class="po_admin_btn_edit" ${a(`Editar post`)}><i class="fas fa-pen"></i> Editar</a><button id="po_refresh" class="po_admin_btn_refresh" ${a(`Recargar`)}><i class="fas fa-rotate"></i></button></div>`:``}
          </div>
